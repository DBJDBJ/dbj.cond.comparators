...
For overview, usage with dbj.cond, tests (with dbj.cond too) and a such please go to the short <a href="https://github.com/DBJDBJ/dbj.cond/blob/master/man.md" target="_blank">**online manual**</a> on the GitHub project. 
